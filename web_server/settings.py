...
SECRET_KEY = 'django-insecure-31+n6%0@h)_w+d8=pdofg@#6%)xephjun7p8b)sp$rb9gyfhxz'
...
DATABASES = {
	'default': {
		...
		'PORT': os.environ.get('MY_DB_PORT', '6432'),
		'NAME': os.environ.get('MY_DB_NAME', 'question_bank', ),
